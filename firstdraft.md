...
<link href="https://fonts.googleapis.com/css2?family=Bree+Serif&family=Orelega+One&family=Pacifico&family=Permanent+Marker&family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&family=Work+Sans&display=swap" rel="stylesheet">


<p style="font-family: 'Work Sans', sans-serif;">Even though it’s a seemingly innocent and commonly used word meant to describe positives, or agreement, the word OK (or okay, ‘kay or even the dreadful k) can and frequently is weaponised. It can be a total mood killer that leaves you drained and unmotivated.
